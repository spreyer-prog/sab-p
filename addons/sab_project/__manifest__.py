{
    ...
    "data": [
        "security/sab_security.xml", "security/ir.model.access.csv", "security/ir.model.access.production_print.csv", "security/ir.model.access.supplier_choice.csv", "security/sab_record_rules.xml",
        "data/sab_classification_data.xml", "data/sab_calculation_sequence.xml", "data/sab_stock_sequence.xml", "data/sab_procurement_request_sequence.xml", "data/sab_work_area_data.xml",
