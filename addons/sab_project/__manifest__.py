{
    ...
    "data": [
        ...
        "views/sab_procurement_detail_views.xml", "views/sab_project_material_overview_views.xml", "views/sab_procurement_visibility_views.xml", "views/sab_procurement_dashboard_views.xml", "views/sab_procurement_package_views.xml", "views/sab_procurement_package_fix_views.xml", "views/sab_minimum_stock_views.xml", "views/sab_delivery_overdue_views.xml", "views/sab_odoo_purchase_bridge_views.xml", "views/sab_odoo_purchase_delivery_views.xml",
