{
    ...
    "data": [
        ...
        "views/sab_sale_order_template_views.xml", "views/sale_order_views.xml", "views/sab_offer_lv_views.xml", "views/sab_offer_switchboard_views.xml", "views/sab_sale_portal_views.xml", "report/sab_sale_order_report.xml",
