{
    ...
    "data": [
        "security/sab_security.xml", "security/ir.model.access.csv", "security/ir.model.access.procurement_package.csv", "security/sab_record_rules.xml",
        ...
        "views/sab_procurement_detail_views.xml", "views/sab_project_material_overview_views.xml", "views/sab_procurement_visibility_views.xml", "views/sab_procurement_dashboard_views.xml", "views/sab_procurement_package_views.xml", "views/sab_procurement_package_fix_views.xml", "views/sab_delivery_overdue_views.xml",
