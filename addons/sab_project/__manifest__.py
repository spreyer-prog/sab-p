{
    ...
    "author": "SAB-P GmbH",
    "license": "LGPL-3",
    "depends": ["auth_signup", "mail", "portal", "project", "sale_management", "purchase_stock"],
    "data": [
        ...
        "views/sab_sale_order_template_views.xml", "views/sale_order_views.xml", "views/sab_sale_order_bom_navigation_views.xml", "views/sab_offer_release_views.xml", "views/sab_offer_lv_views.xml", "views/sab_offer_switchboard_views.xml", "views/sab_offer_reuse_panel_views.xml", "views/sab_sale_portal_views.xml", "report/sab_sale_order_report.xml",
        ...
        "views/sab_production_order_views.xml", "views/sab_production_document_views.xml", "views/sab_production_print_views.xml", "wizard/sab_production_print_wizard_views.xml", "views/sab_production_print_profile_views.xml",
        "report/sab_production_document_report.xml", "report/sab_production_document_filename.xml", "report/sab_production_document_report_exact.xml", "report/sab_production_document_report_master_v2.xml", "report/sab_production_document_report_master_v5_orientation.xml", "report/sab_production_document_report_master_labels.xml", "report/sab_production_document_report_master_v6_native_formats.xml", "report/sab_production_document_report_master_v7_native_typography.xml", "report/sab_production_document_report_master_v3.xml", "report/sab_production_document_report_folder_label.xml", "report/sab_production_document_report_master_v4_layout.xml", "report/sab_production_document_report_conformity.xml",
        "report/sab_production_document_report_run_card_original.xml", "report/sab_production_document_report_production_test_original.xml", "report/sab_production_document_report_final_inspection_original.xml", "report/sab_production_document_report_shipping_original.xml", "report/sab_production_document_report_nameplate_original.xml", "report/sab_production_document_report_info_sheet_original.xml", "report/sab_production_document_report_missing_parts_original.xml", "report/sab_production_document_report_add_pack_original.xml", "report/sab_production_document_report_folder_label_original.xml",
        "views/sab_purchase_requirement_views.xml", "views/sab_stock_movement_views.xml", "views/sab_procurement_views.xml", "views/sab_stock_workspace_views.xml",
        "views/sab_procurement_detail_views.xml", "views/sab_project_material_overview_views.xml", "views/sab_procurement_visibility_views.xml", "views/sab_procurement_dashboard_views.xml", "views/sab_procurement_package_views.xml", "views/sab_procurement_package_fix_views.xml", "views/sab_bom_procurement_handover_views.xml", "views/sab_minimum_stock_views.xml", "views/sab_delivery_overdue_views.xml", "views/sab_odoo_purchase_bridge_views.xml", "views/sab_odoo_purchase_delivery_views.xml", "views/sab_odoo_purchase_project_views.xml", "views/sab_odoo_commissioning_views.xml", "views/sab_odoo_purchase_approval_views.xml", "views/sab_purchase_bulk_and_merge_views.xml", "views/sab_odoo_receipt_security_views.xml", "views/sab_supplier_confirmation_views.xml", "views/sab_three_way_match_views.xml", "wizard/sab_supplier_choice_wizard_views.xml",
