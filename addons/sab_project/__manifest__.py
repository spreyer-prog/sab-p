{
    ...
    "data": [
        ...
        "views/sab_production_order_views.xml", "views/sab_production_document_views.xml", "views/sab_purchase_requirement_views.xml", "views/sab_stock_movement_views.xml", "views/sab_procurement_views.xml", "views/sab_stock_workspace_views.xml",
