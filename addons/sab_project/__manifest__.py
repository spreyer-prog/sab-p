{
    ...
    "data": [
        "security/sab_security.xml", "security/ir.model.access.csv", "security/ir.model.access.procurement.csv", "security/sab_record_rules.xml",
        ...
        "views/sab_sale_order_template_views.xml", "views/sale_order_views.xml", "views/sab_offer_lv_views.xml", "views/sab_offer_switchboard_views.xml", "views/sab_offer_reuse_panel_views.xml", "views/sab_sale_portal_views.xml", "report/sab_sale_order_report.xml",
        ...
        "views/sab_procurement_detail_views.xml", "views/sab_project_material_overview_views.xml", "views/sab_procurement_visibility_views.xml",
        "report/sab_purchase_order_report.xml", "report/sab_purchase_order_delivery_report.xml",
