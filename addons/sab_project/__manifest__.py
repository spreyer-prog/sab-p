{
    ...
    "data": [
        "security/sab_security.xml",
        "security/ir.model.access.csv",
        "security/sab_record_rules.xml",
        "data/sab_classification_data.xml",
        "data/sab_calculation_sequence.xml",
        "data/sab_stock_sequence.xml",
        "data/sab_work_area_data.xml",
        "views/sab_menu_views.xml",
        "views/sab_employee_admin_views.xml",
        "views/sab_employee_confidential_views.xml",
        "views/sab_calculation_item_views.xml",
        "views/res_config_settings_views.xml",
        "views/project_project_views.xml",
        "views/project_customer_portal_views.xml",
